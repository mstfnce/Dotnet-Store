...
public class OrderController : Controller
{
    ...
    private async Task<Payment> ProcessPayment(OrderCreateModel model, Cart cart)
    {
        ...
        request.Price = cart.AraToplam().ToString("0.00", CultureInfo.InvariantCulture);
        request.PaidPrice = cart.AraToplam().ToString("0.00", CultureInfo.InvariantCulture);
        ...
        buyer.Email = "johnwick52@hotmail.com";
        ...
        foreach (var item in cart.CartItems)
        {
            ...
            basketItem.Price = (item.Urun.Fiyat * item.Miktar).ToString("0.00", CultureInfo.InvariantCulture);
